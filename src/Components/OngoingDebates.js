...
export default function OngoingDebates({ image1, image2, name1, name2, title, userimg1, userimg2, Badgeimg1, Badgeimg2 }) {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ position: 'absolute', width: '100%' }}>
                <TouchableOpacity onPress={() => { navigation.navigate('LibraryStream') }}>
                    <View style={styles.userheader}>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <Image source={userimg1} style={styles.userimg} />
                            <Text style={styles.username} > {name1}</Text>
                            <Image source={Badgeimg1} style={{ height: 18, width: 18, }} />
                        </View>
                        <View style={{ flexDirection: 'row', alignItems: 'center', marginLeft: '26%' }}>
                            ...
                            <Image source={Badgeimg2} style={{ height: 18, width: 18,  }} />
                        </View>
                    </View>
